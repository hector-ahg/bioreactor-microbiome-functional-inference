...
DATASET="SV"        # change to SVR when needed

DADA2_RESULTS_DIR="/Users/hector/git/bioreactor-microbiome-functional-inference/results/results_3_checked/${DATASET}/dada2_trimmed_F255_R220"
