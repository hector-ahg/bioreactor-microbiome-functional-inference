...
DATASET="inocula"        # change to proportions when needed
DADA2_RESULTS_DIR="/Users/hector/git/bioreactor-microbiome-functional-inference/results/results_1_checked/${DATASET}/dada2_trimmed_F260_R215"
