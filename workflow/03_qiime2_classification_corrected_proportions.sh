...
DATASET="proportions"        # change to inocula when needed
DADA2_RESULTS_DIR="/Users/hector/git/bioreactor-microbiome-functional-inference/results/results_1_checked/${DATASET}/dada2_trimmed_F245_R183"
TABLE="${DADA2_RESULTS_DIR}/table.qza"
REP_SEQS="${DADA2_RESULTS_DIR}/rep-seqs.qza"
